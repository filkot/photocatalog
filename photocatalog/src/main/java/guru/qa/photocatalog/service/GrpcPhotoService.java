...
import guru.qa.grpc.fotocatalog.*;
...
@Service
public class GrpcPhotoService extends FotocatalogServiceGrpc.FotocatalogServiceImplBase {
    ...
    @Override
    public void randomPhoto(CountRequest request, StreamObserver<PhotoResponse> responseObserver) {
